RFI_SQL_PROMPT = (
    ...
    "- Always SELECT d.code AS document_code and d.title AS subject.\n"
    "- Alias COUNT(*) as count when counting.\n"
    "- Alias d.code As document_code when selecting.\n"
    "- Alias d.title As subject when selecting.\n"
    "- Mandatory WHERE filters: d.is_private = FALSE, d.deleted IS NULL, d.type = 0.\n"
    "- If recency implied (latest/newest/most recent), ORDER BY d.created_at DESC; otherwise ASC.\n"
